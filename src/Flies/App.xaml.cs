    ...
    public partial class App : Application
    {
        ...
        private void ShowHelp()
        {
            if (AttachConsole(ATTACH_PARENT_PROCESS))
            {
                ...
                Console.WriteLine();
                Console.WriteLine("-c\t--count\tCount of rick to display, default is 1 (more rick = more lag)");
                Console.WriteLine("-d\t--delay\tDelay (in seconds) until the rick(s) appear (0-86400)");
